...
import { useToast } from "@/components/ui/toast"; // <-- Импорт

export default function RegistrationFlow() {
  const t = useTranslations("Auth");
  const tToast = useTranslations("Toast"); // <-- Для ошибок
  ...
  const schemas = getAuthSchemas(tToast); // <-- Передаем словарь тостов
